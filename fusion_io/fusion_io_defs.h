...
FIO_DEFINE_INT(FIO_HAS_NIMROD,       1)
#else
FIO_DEFINE_INT(FIO_HAS_NIMROD,       0)
#endif
...
FIO_DEFINE_INT(FIO_TOTAL_RADIATION,   6)
FIO_DEFINE_INT(FIO_RESISTIVITY,      20)
FIO_DEFINE_INT(FIO_VISCOSITY,        30)
FIO_DEFINE_INT(FIO_THERMAL_DIFFUSIVITY, 40)
FIO_DEFINE_INT(FIO_JBS,              50)
FIO_DEFINE_INT(FIO_JBS_dndpsi,       51)
FIO_DEFINE_INT(FIO_JBS_dtedpsi,      52)
FIO_DEFINE_INT(FIO_JBS_dtidpsi,      53)
FIO_DEFINE_INT(FIO_JBS_L31,           54)
FIO_DEFINE_INT(FIO_JBS_L32,           55)
FIO_DEFINE_INT(FIO_JBS_L34,           56)
FIO_DEFINE_INT(FIO_JBS_alpha,         57)
...
FIO_DEFINE_INT(FIO_GEQDSK_XLIM,       3011)
FIO_DEFINE_INT(FIO_GEQDSK_YLIM,       3012)
...
FIO_DEFINE_INT(FIO_GEQDSK_NLIM,       4011)
